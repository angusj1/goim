...
curl -L https://www.apache.org/dyn/closer.lua/zookeeper/zookeeper-3.6.3/apache-zookeeper-3.6.3-bin.tar.gz -o apache-zookeeper-3.6.3-bin.tar.gz
tar zxf apache-zookeeper-3.6.3-bin.tar.gz
mkdir -p $ZK_HOME
echo $ZK_ID>$ZK_HOME/myid
mv apache-zookeeper-3.6.3-bin.tar.gz/* $ZK_HOME
